      ...
      <div class="row border rounded-6 p-3 bg-white shadow box-area" style="border-radius: 20px">
        ...
        <div class="col-md-6 d-flex justify-content-center align-items-center flex-column left-content">
          <div class="loginimage mb-3">
            <img src="../assets/images/login.jpg" class="img-fluid login-image" style="width: 345px" />
          </div>
        </div>
        ...
        <div class="col-md-6 right-content">
          <div>
            <h4 class="login-title">Hello Again</h4>
            <p class="sign-in-title">Sign-In to get started</p>
          </div>
          <div>
            ...
            <div class="button-group" style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
            ...
            <div class="sign-in-or">
              ...
              <span style="padding: 0 10px; color: #666; font-size: 15px">or</span>
              <hr style="flex: 1; border: 1px; border-top: 1px solid black" />
            </div>

            <div class="button-group">
              <button type="button" class="btn btn-light google-signin-btn" @click="GoogleSignin">
                <img src="../assets/images/google.png" style="width: 1rem; margin-right: 20px" />
                <small class="sign-in-ggl">Sign in with Google</small>
              </button>
            </div>

            <div class="row mt-3 mb-3">
              <small class="account">Don't have an account? &nbsp;<RouterLink to="/signup-page">Sign-up</RouterLink></small>
            </div>
          </div>
        </div>
      </div>
...
const login = () => {
  // Simulated login for static deploy
  console.log('Login clicked (static build)');
